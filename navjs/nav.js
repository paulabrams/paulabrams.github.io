        ...
        if (navjs.data && navjs.data[0]) {
          ...
          if (metricData !== undefined) {
            ...
            if (nav.metric_value === undefined || nav.metric_value < 0.001) {
              nav.metric_value = navjs.blankRendered
            }
          ...
          if (comparisonData !== undefined) {
            ...
            if (nav.comparison_value === undefined || nav.comparison_value < 0.001) {
              nav.comparison_value = navjs.blankRendered
            }
            ...
            else if (nav.comparison_value !== navjs.blankRendered && nav.comparison_style === "show_as_change" ||  nav.comparison_style === "show_as_change_reversed") {
